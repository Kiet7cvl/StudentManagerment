            ...
            <div class="major_create">
                <form action="classcreate" method="POST">
                    <ul class="major_form_cre" style="list-style: none;">
                        <li><h4>ClassID</h4></li>
                        <li><input  style="height: 40px; width: 95%;" type="text" name="classid" value="" placeholder="Enter classID" /></li>
                        
                        <p style="color: red">${error}</p>
                        <li><h4>ClassName</h4></li>
                        <li><input  style="height: 40px; width: 95%;" type="text" name="classname" value="" placeholder="Enter className" /></li>
                    </ul>

                    <input style="background-color: green" class="major_create_buton" type="submit" name="" value="Create"/>
                    <a style="background-color: red;" href="classload"> <i class="fa-regular fa-circle-xmark"></i> Cancel</a>
