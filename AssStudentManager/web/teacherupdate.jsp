            ...
            <div class="major_create">
                <form action="teacherupdate" method="POST">
                    <ul class="major_form_cre" style="list-style: none;">
                        ...
                        <li><input  style="height: 30px; width: 95%;" type="text" name="teacherid" value="${sc.getTeacherid()}" placeholder="Enter TeacherID" readonly=""/></li>
                        <p style="color: red">${error}</p>
                        <li><h4 style="margin: 10px 0px;">TeacherName</h4></li>
                        <li><input  style="height: 30px; width: 95%;" type="text" name="teachername" value="${sc.getTeachername()}" placeholder="Enter TeacherName" /></li>
                        <li><h4 style="margin: 10px 0px;">Phone</h4></li>
                        <li><input  style="height: 30px; width: 95%;" type="text" name="phone" value="${sc.getPhone()}" placeholder="Enter Phone" /></li>
                        <li><h4 style="margin: 10px 0px;">Literacy</h4></li>
                        <li><input  style="height: 30px; width: 95%;" type="text" name="literacy" value="${sc.getLiteracy()}" placeholder="Enter Literacy" /></li>
                        <li><h4 style="margin: 10px 0px;">Nationality</h4></li>
                        <li><input  style="height: 30px; width: 95%;" type="text" name="nationality" value="${sc.getNationality()}" placeholder="Enter Nationality" /></li>
