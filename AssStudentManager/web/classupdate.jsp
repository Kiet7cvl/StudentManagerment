            ...
            <div class="major_create">
                <form action="classupdate" method="POST">
                    <ul class="major_form_cre" style="list-style: none;">
                        <li><h4>ClassID</h4></li>
                        <li><input  style="height: 40px; width: 95%;" type="text" name="classid" value="${sc.getClassid()}" readonly=""/></li>


                        <li><h4>ClassName</h4></li>
                        <li><input  style="height: 40px; width: 95%;" type="text" name="classname" value="${sc.getClassname()}"/></li>
                    </ul>
