            ...
            <div class="major_create">
                <form action="subjectupdate" method="POST">
                    <ul class="major_form_cre" style="list-style: none;">
                        ...
                        <li><input  style="height: 40px; width: 95%;" type="text" name="subjectid" value="${sc.getSubjectid()}" readonly=""/></li>


                        <li><h4>SubjectName</h4></li>
                        <li><input  style="height: 40px; width: 95%;" type="text" name="subjectname" value="${sc.getSubjectname()}"/></li>
                        <li><h4>MajorID</h4></li>
