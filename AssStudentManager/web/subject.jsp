        ...
        <div style="margin: 50px; background-color: white; padding: 8px; box-shadow: 5px 0px 10px 2px #888888;" class="box">
            ...
            <div class="major_cre" style="display: flex; justify-content: space-between">
                ...
                <a style="  text-decoration: none; border: 1px solid black; background-color: green; color: white; padding: 12px;
                   margin-bottom: 25px; border-radius: 4px;" href="subjectcreate.jsp"> <i class="fa-solid fa-circle-plus"></i> CREATE</a>
                   </c:if>
            </div>

            <form action="subjectsearch" method="POST">
                <div style="margin-bottom: 30px; display: flex;">
                    <input style="height: 30px; width: 400px;" type="text" name="subjectidname" value="" placeholder="Enter Subject want to find"/>
                ...
                <table style=" line-height: 1.7;" >
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th style="padding-right: 200px;">SubjectID</th>
                            <th style="padding-right: 300px;">SubjectName</th>
                            <th style="padding-right: 100px;">MajorID</th>
                            <th>Operation</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <c:forEach items="${getAll}" var="op">
                            <tr>
                                ...
                                <td>${op.getSubjectname()}</td>  
                                <td>${op.getMajorid()}</td> 
                                <td>
                                    <c:if test="${sessionScope.user.isAdmin == 1}">
                                        <a href="subjectupdate?sid=${op.getSubjectid()}"><i class="fa-sharp fa-regular fa-pen-to-square"></i></a>
<!--                                    <a href="#" onclick="Mess(${op.getSubjectid()})">DELETE</a>-->
                                    <a style="margin-left: 10px;" href="subjectcreate?sid=${op.getSubjectid()}"><i class="fa-sharp fa-solid fa-trash"></i></a>
                                    </c:if>
