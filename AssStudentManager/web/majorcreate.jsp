            ...
            <div class="major_create">
                <form action="create" method="POST">
                    <ul class="major_form_cre" style="list-style: none;">
                        <li><h4>MajorID</h4></li>
                        <li><input  style="height: 40px; width: 95%;" type="text" name="majorid" value="" placeholder="Enter majorID" /></li>
                        
                        <p style="color: red">${error}</p>
                        <li><h4>MajorName</h4></li>
                        <li><input  style="height: 40px; width: 95%;" type="text" name="majorname" value="" placeholder="Enter majorName" /></li>
                    </ul>
